      ...
      <div class="d-flex justify-content-center align-items-center container padding-top">
        <form action="" method="post" class="border border-success">
          <div class="col-sm-10 offset-sm-1">
            ...
            <div class="form-group">
              <label for="num2">Enter nth root</label><br>
            ...
            if($_POST){
                if(in_array('',$_POST)){
                    ...
                    $root = pow( $_POST['num1'], $_POST['num2'] ); 
                    echo "The {$_POST['num2'] }th root of {$_POST['num1']} is {$root} <br><br>" ;
                }
            }
            ?>
             </div>
